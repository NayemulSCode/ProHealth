            ...
            <form className="form" onSubmit={handleSubmit}>
                <table className="table-fill">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <label htmlFor="grams">grams/kg</label>
                            </td>
                            <td>
                                <input
                                    onChange={onChange}
                                    defaultValue={vars.grams}
                                    ref={refs.grams}
                                    name="grams"
                                    id="grams"
                                    type="text"
                        ...
                        <tr>
                            <td>
                                <label htmlFor="tCarbs">total gm carbs</label>
                            </td>
                            <td>
                                <input
                                    onClick={onChange}
                                    defaultValue={vars.tCarbs}
                                    ref={refs.tCarbs}
                                    name="tCarbs"
                                    id="tCarbs"
                                    type="number"
                        ...
                        <tr>
                            <td>
                                <label htmlFor="pOfCals">% of cals</label>
                            </td>
                            <td>
                                <input
                                    onClick={onChange}
                                    defaultValue={vars.pOfCals}
                                    ref={refs.pOfCals}
                                    id="pOfCals"
                                    name="pOfCals"
                                    type="number"
